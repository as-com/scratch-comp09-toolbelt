...
(function(v){function b(a,c,k){if(k!==h)return a instanceof b?a:"undefined"===typeof a?n:b.parse(a);for(a=a||[];a.length&&!a[a.length-1];)--a.length;this._d=a;this._s=a.length?c||1:0}var h={};b._construct=function(a,c){return new b(a,c,h)};b.base=1E7;b.base_log10=7;var n=new b([],0,h);b.ZERO=n;var p=new b([1],1,h);b.ONE=p;var t=new b(p._d,-1,h);b.M_ONE=t;b._0=n;b._1=p;b.small=[n,p,new b([2],1,h),new b([3],1,h),new b([4],1,h),new b([5],1,h),new b([6],1,h),new b([7],1,h),new b([8],1,h),new b([9],1,
...
if(0<a.compareAbs(u))throw Error("exponent too large in BigInteger.pow");for(var c=this,k=p,g=b.small[2];a.isPositive()&&(!a.isOdd()||(k=k.multiply(c),!a.isUnit()));)c=c.square(),a=a.quotient(g);return k};b.prototype.modPow=function(a,c){for(var k=p,g=this;a.isPositive();)a.isOdd()&&(k=k.multiply(g).remainder(c)),a=a.quotient(b.small[2]),a.isPositive()&&(g=g.square().remainder(c));return k};b.prototype.log=function(){switch(this._s){case 0:return-Infinity;case -1:return NaN}var a=this._d.length;if(30>
7*a)return Math.log(this.valueOf());var c=Math.ceil(30/7),k=this._d.slice(a-c);return Math.log((new b(k,1,h)).valueOf())+(a-c)*Math.log(1E7)};b.prototype.valueOf=function(){return parseInt(this.toString(),10)};b.prototype.toJSValue=function(){return parseInt(this.toString(),10)};var u=b(2147483647);b.MAX_EXP=u;(function(){function a(a){return function(c){return a.call(b(c))}}function c(a){return function(c,d){return a.call(b(c),b(d))}}function k(a){return function(c,d,f){return a.call(b(c),b(d),b(f))}}
(function(){var g,h,d="toJSValue isEven isOdd sign isZero isNegative abs isUnit square negate isPositive toString next prev log".split(" "),f="compare remainder divRem subtract add quotient divide multiply pow compareAbs".split(" "),e=["modPow"];for(g=0;g<d.length;g++)h=d[g],b[h]=a(b.prototype[h]);for(g=0;g<f.length;g++)h=f[g],b[h]=c(b.prototype[h]);for(g=0;g<e.length;g++)h=e[g],b[h]=k(b.prototype[h]);b.exp10=function(a,c){return b(a).exp10(c)}})()})();v.BigInteger=b})("undefined"!==typeof exports?
exports:this);
